...
import numpy as np
from ImageVista_utils import ImageVistaBaseGenerator, get_G, save_image
...
generator = ImageVistaBaseGenerator(G, config, 10) 
...
if not os.path.exists('./samples'):
    os.mkdir('./samples')
save_image(img, 'samples/ImageVista_%s_seed_%d_score_%.4f.png'%(sentence, args.seed, score))
